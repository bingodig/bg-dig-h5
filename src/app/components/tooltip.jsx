...
var Tooltip = React.createClass({
	...
	render: function() {
		...
		var classes = this.getClasses('dig-tooltip', {
		  'dig-is-shown': this.props.show,
		  'dig-is-touch': this.props.touch
		});

		return (
			<div {...other} className={classes}>
			  <div ref="ripple" className="dig-tooltip-ripple" />
			  <span className="dig-tooltip-label">{this.props.label}</span>
			</div>
		);
	},
