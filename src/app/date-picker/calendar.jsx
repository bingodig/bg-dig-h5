      ...
      <div className={classes}>
        ...
        <div className="dig-date-picker-calendar-container">
          ...
          <ul className="dig-date-picker-calendar-week-title">
            <li className="dig-date-picker-calendar-week-title-day">S</li>
            <li className="dig-date-picker-calendar-week-title-day">M</li>
            <li className="dig-date-picker-calendar-week-title-day">T</li>
            <li className="dig-date-picker-calendar-week-title-day">W</li>
            <li className="dig-date-picker-calendar-week-title-day">T</li>
            <li className="dig-date-picker-calendar-week-title-day">F</li>
            <li className="dig-date-picker-calendar-week-title-day">S</li>
          </ul>
